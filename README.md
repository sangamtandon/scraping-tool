...
# HOW TO SCRAPE
To initiate web scraping, execute the command provided below in the terminal. Optionally, adjust the page count and proxy settings within the request parameters:

Invoke-WebRequest -Uri 'http://127.0.0.1:8000/scrape?max_pages=10' -Method Get -Headers @{'x-token' = 'my_secret_token'}
